...
async def start(message: types.Message):
    welcome_text = (
        "Привет! Я Андрей 👋\n"
        "Я сам из бизнеса: команда, выручка, сложные решения. Всё как у тебя.\n\n"
        "Скоро я выступаю на IT-конференции. Хочу, чтобы это был не доклад «про успех»,\n"
        "а разговор по делу — про то, **что болит** у предпринимателей сегодня.\n\n"
        "🔍 Я сделал этот бот, чтобы провести мини-аудит и понять:\n"
        "что ты чувствуешь, где буксует бизнес, куда сейчас нужен рывок.\n\n"
        "5 вопросов. 1 минута. Анонимно. По-честному.\n\n"
...
"
        "Если хочешь — подпишись, чтобы потом получить итоги в PDF:
"
        "[t.me/painaudit_bot](https://t.me/painaudit_bot)",
        parse_mode="Markdown"
    )
